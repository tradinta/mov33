...
import { EventFilters, EventFilter } from "@/components/events/event-filter";
...
import { RecentlyViewedList, WelcomeBackBanner } from '@/components/events/personalized-components';
