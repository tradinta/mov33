...
export function UpgradeCard() {
    ...
    return (
        <GlassCard className="relative overflow-hidden border-gold/20 bg-gradient-to-br from-obsidian via-obsidian to-gold/5">
            {/* Decorative Glows */}
            ...
            <div className="relative p-8 md:p-12 space-y-12">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="space-y-4">
                        ...
                        <h2 className="font-headline text-4xl md:text-5xl font-black uppercase italic tracking-tighter text-white">
                            Unlock the <span className="text-gold">Full Experience</span>
                        </h2>
                        <p className="text-white/60 font-poppins text-sm md:text-base max-w-xl leading-relaxed">
                    ...
                    <div className="flex flex-col items-center gap-4 bg-white/5 backdrop-blur-xl p-8 rounded-3xl border border-white/10 min-w-[280px]">
                        <div className="text-center">
                            <span className="text-white/40 text-[10px] font-black uppercase tracking-widest block mb-2">Annually</span>
                            <div className="flex items-end justify-center gap-1">
                                <span className="text-4xl font-black text-white font-headline tracking-tighter">KES 4,999</span>
                                <span className="text-white/40 text-[10px] font-black uppercase tracking-widest mb-1">/yr</span>
                            </div>
                        </div>
                        <Button
                        ...
                        <p className="text-[9px] text-white/30 uppercase font-bold tracking-tighter">Cancel anytime • Secure payment</p>
                    </div>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="space-y-1">
                                    <h4 className="text-white font-bold text-sm uppercase tracking-tight">{benefit.title}</h4>
