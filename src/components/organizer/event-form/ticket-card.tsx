...
import { Copy, DollarSign, Percent, PlusCircle, Trash2 } from 'lucide-react';
...
export function TicketCard({ index, remove, append, isAdvanced }: TicketCardProps) {
      ...
      <div className="absolute top-2 right-2 flex items-center gap-1">
        <Button
          ...
          onClick={() => {
            ...
            append({ ...currentValues, tier: `${currentValues.tier} (Copy)` });
          }}
